...
MY_PATH = '/Users/etienneeskinazi/Documents/MS_BGD/P1/Kit Big Data/analyse_cooking_app/etude_app_cuisine/data/'
...
def load_data(file_name):
    return pd.read_json(MY_PATH + file_name, lines=True)
...
# Charger les données
df_RAW_recipes = load_data('df_RAW_recipes.json')
df_RAW_interactions = load_data('df_RAW_interactions.json')
df_recipes_stats = load_data('df_recipes_stats.json')
